...
// Saberra S icon, 48x48 PNG encoded as base64
export const SABERRA_ICON_B64 = '';
...
function fmt(iso: string | null): string {
  ...
  return new Date(iso).toLocaleString('en-US', {
    ...
    hour12: true, timeZone: process.env.DASHBOARD_TIMEZONE ?? 'UTC',
  });
}
...
const SERA_TIPS_ES: Array<{ badge: string; text: string }> = [
  { badge: 'Consejo Pro', text: 'Reenvía cualquier correo a <strong>roots@amora.cr</strong> y extraeré las decisiones, tareas, riesgos y personas mencionadas, archivándolos como borradores para tu revisión. Nada se convierte en canon hasta que un humano lo apruebe.' },
  ...
  { badge: '¿Sabías que...?', text: 'El contador de <strong>Horas Estimadas Ahorradas</strong> calcula: 45 min por reunión procesada + 5 min por correo + 2 min por tarea extraída + 3 min por decisión registrada. Crece con cada ciclo.' },
  { badge: '¿Sabías que...?', text: 'Nunca apruebo cambios de canon por mi cuenta. Cuando detecto algo que podría afectar una política, definición de círculo o regla de gobernanza, creo una <strong>Solicitud de Cambio de Canon</strong> marcada Pendiente de Revisión y aviso al administrador.' },
  { badge: 'Consejo Pro', text: 'El campo <strong>Ref. de Política</strong> se formatea automáticamente como un código corto tipo GOV-001, OPS-002 o FIN-003. Usa estos códigos en notas de reunión y vincularé las decisiones a la política correcta automáticamente.' },
  { badge: '¿Sabías que...?', text: 'Verifico si hay <strong>registros duplicados</strong> antes de escribir. Si la misma tarea o decisión aparece en un ciclo de reintento, la omito. Tus bases de datos de Notion se mantienen limpias automáticamente.' },
  { badge: 'Consejo Pro', text: 'Las marcas sensibles (problemas legales, conflictos interpersonales, riesgos financieros) van a una <strong>base de datos de Revisión Sensible solo para administradores</strong>, nunca visible en las colas compartidas del equipo. Esos registros son privados por diseño.' },
  { badge: '¿Sabías que...?', text: 'Extraigo participantes de las transcripciones y creo o actualizo sus <strong>Perfiles</strong> automáticamente. Toda persona que participa en reuniones grabadas acumula un registro de contacto con el tiempo, sin necesidad de entrada manual.' },
  { badge: 'Consejo Pro', text: 'Usa la <strong>pestaña Chat</strong> para hacerme preguntas directamente. Comienza con "Hey Sera", por ejemplo: "Hey Sera, ¿qué decisiones se tomaron sobre la tierra el mes pasado?" Busco en toda tu memoria institucional para responder.' },
  { badge: '¿Sabías que...?', text: 'Si hay un <strong>Enunciado de Propósito Rector</strong> configurado, evalúo cada decisión candidata según su alineación con el propósito antes de archivarla. Las decisiones que se alejan del GPS se marcan para revisión.' },
  { badge: 'Consejo Pro', text: 'La <strong>Cola de Revisión de Memoria</strong> contiene hechos valiosos como conocimiento institucional a largo plazo. Revísala regularmente: las memorias aprobadas forman parte del contexto que uso al interpretar contenido futuro.' },
  { badge: '¿Sabías que...?', text: 'Funciono en un ciclo de verificación de <strong>3 minutos</strong> en Railway. La mayoría de los correos se procesan en 5 minutos desde su llegada. El tiempo de Último Sondeo Exitoso en Salud del Sistema muestra cuándo revisé la bandeja por última vez.' },
  { badge: 'Consejo Pro', text: 'Para ayudarme a vincular una reunión al círculo del equipo correcto, menciona el nombre del círculo explícitamente en el título o la agenda de la reunión. Uso coincidencia de patrones para asociar decisiones y tareas con el registro de círculo correcto.' },
  { badge: 'Consejo Pro', text: 'Cuando una reunión o correo contiene instrucciones, mejores prácticas o guías de proceso, creo automáticamente un <strong>artículo de Base de Conocimiento</strong> en estado Borrador. Revisa y publica los que valgan para construir tu biblioteca de referencia viva.' },
  { badge: '¿Sabías que...?', text: 'La plataforma que estás usando se llama <strong>Saberra</strong>, el nombre productizado de este sistema de memoria viva. El nombre lleva silenciosamente <em>saber</em>. Saberra está construida para los equipos que no pueden permitirse olvidar. Soy Sera, tu guardiana de la memoria de IA dentro de ella.' },
];
...
interface UiStrings {
  ...
  sectionDbPermissions: string;
  dbPermissionsDesc: string;
  dbPermColCreate: string;
  dbPermColUpdate: string;
  dbPermLocked: string;
...
const UI_EN: UiStrings = {
  ...
  dbPermColCreate: 'Create',
  dbPermColUpdate: 'Update',
  dbPermLocked: 'Infrastructure',
...
const UI_ES: UiStrings = {
  ...
  dbPermColCreate: 'Crear',
  dbPermColUpdate: 'Actualizar',
  dbPermLocked: 'Infraestructura',
...
function getDashboardLocale(language: string): { tips: Array<{ badge: string; text: string }>; ui: UiStrings } {
  ...
  const applyEmail = (tips: Array<{ badge: string; text: string }>) =>
    tips.map(t => ({ ...t, text: t.text.replace(/roots@amora\.cr/g, rootsEmail) }));
  if (language === 'Spanish') return { tips: applyEmail(SERA_TIPS_ES), ui: UI_ES };
  return { tips: applyEmail(SERA_TIPS), ui: UI_EN };
}
...
<div class="wrap">
  ...
  <div id="tab-settings" class="tab-panel">
    ...
    <section>
      <h2>${locale.ui.sectionDbPermissions}</h2>
      <p class="dim" style="margin-bottom:16px">${locale.ui.dbPermissionsDesc}</p>
      ${d.systemConfig.hubSettingsConfigured ? `
      <div style="overflow-x:auto">
        <table style="width:100%;border-collapse:collapse;font-size:13px">
          <thead>
            <tr style="border-bottom:2px solid var(--border)">
              <th style="text-align:left;padding:8px 12px;font-weight:600;color:var(--muted)">Database</th>
              <th style="text-align:center;padding:8px 12px;font-weight:600;color:var(--muted);width:80px">${locale.ui.dbPermColCreate}</th>
              <th style="text-align:center;padding:8px 12px;font-weight:600;color:var(--muted);width:80px">${locale.ui.dbPermColUpdate}</th>
            </tr>
          </thead>
          <tbody>
            ${[
              ...
              ['canonChangeRequests','Canon Change Requests'],
              ['ccosLedgerEntries',  'CCOS Ledger Entries'],
              ...(d.systemConfig.enabledDbs['knowledgeBase']  ? [['knowledgeBase',  'Knowledge Base']]  as [string,string][] : []),
              ...(d.systemConfig.enabledDbs['interactions']   ? [['interactions',   'Interactions']]    as [string,string][] : []),
              ...(d.systemConfig.enabledDbs['tensions']       ? [['tensions',       'Tensions']]        as [string,string][] : []),
              ...(d.systemConfig.enabledDbs['commitments']    ? [['commitments',    'Commitments']]     as [string,string][] : []),
              ...(d.systemConfig.enabledDbs['gratitudes']     ? [['gratitudes',     'Gratitudes']]      as [string,string][] : []),
              ...(d.systemConfig.enabledDbs['events']         ? [['events',         'Events']]          as [string,string][] : []),
              ...(d.systemConfig.enabledDbs['retrospectives'] ? [['retrospectives', 'Retrospectives']]  as [string,string][] : []),
              ...(d.systemConfig.enabledDbs['resources']      ? [['resources',      'Resources']]       as [string,string][] : []),
            ].map(([key, label]) => {
              const p = d.systemConfig.dbPermissions[key as string];
              const canCreate = p?.create !== false;
              const canUpdate = p?.update !== false;
              return `<tr style="border-bottom:1px solid var(--border)">
                <td style="padding:8px 12px;font-weight:500">${label}</td>
                <td style="text-align:center;padding:8px 12px"><input type="checkbox" class="db-perm" data-key="${key}" data-op="create"${canCreate ? ' checked' : ''} style="width:16px;height:16px;cursor:pointer;accent-color:var(--accent)"></td>
                <td style="text-align:center;padding:8px 12px"><input type="checkbox" class="db-perm" data-key="${key}" data-op="update"${canUpdate ? ' checked' : ''} style="width:16px;height:16px;cursor:pointer;accent-color:var(--accent)"></td>
              </tr>`;
            }).join('')}
            ${[
              ['sourceEmails',   'Source Emails'],
              ['meetings',       'Meetings'],
              ['meetingAssets',  'Meeting Assets'],
              ['processingEvents','Processing Events'],
              ['sensitiveReview','Sensitive Review'],
            ].map(([, label]) => `<tr style="border-bottom:1px solid var(--border);opacity:0.5">
                <td style="padding:8px 12px">${label} <span style="font-size:10px;background:var(--border);color:var(--muted);padding:1px 5px;border-radius:4px;vertical-align:middle">${locale.ui.dbPermLocked}</span></td>
                <td style="text-align:center;padding:8px 12px"><input type="checkbox" checked disabled style="width:16px;height:16px;accent-color:var(--accent)"></td>
                <td style="text-align:center;padding:8px 12px"><input type="checkbox" checked disabled style="width:16px;height:16px;accent-color:var(--accent)"></td>
              </tr>`).join('')}
          </tbody>
        </table>
      ...
      <div style="margin-top:14px;display:flex;align-items:center;gap:10px">
        <button onclick="saveDbPermissions()" style="font-size:13px;padding:6px 16px;background:var(--accent);color:#fff;border:none;border-radius:6px;cursor:pointer;font-weight:500">${locale.ui.btnSavePermissions}</button>
        <span id="db-perm-status" style="font-size:12px;color:var(--muted)"></span>
      </div>
      ` : `<p class="dim">${locale.ui.hubSettingsNotConfigured}</p>`}
    </section>
