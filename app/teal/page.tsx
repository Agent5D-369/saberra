...
export default function TealPage() {
  return (
    <SegmentPage
      ...
      painIntro="Self-managing teams create governance agreements constantly. The failure mode is not bad decisions — it is that the record of those decisions drifts into transcripts, old proposals, email threads, and the memory of whoever happened to be in the room."
      pains={[
