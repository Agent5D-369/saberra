...
export const metadata: Metadata = {
  ...
  description:
    "See how Saberra captures Google Meet outputs and email, extracts structured records with AI, routes them through human review, stores them in Notion, and lets teams ask Sera sourced questions.",
      ...
      <section className="section tight">
        <div className="container split">
          <SectionHeader title="The team keeps working. The memory keeps growing.">
            A dedicated inbox receives Google Meet outputs and important operational email. AI extraction proposes structured
          ...
          <ul className="list">
            ...
            <li>AI extraction creates candidates for decisions, tasks, roles, risks, policies, and memory.</li>
            <li>Records enter 20 structured Notion databases with status and source traceability.</li>
